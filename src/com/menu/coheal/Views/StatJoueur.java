...
public class StatJoueur {
   Resources theme ; 
     ...
     */
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Joueur> ab) {
        CategorySeries series = new CategorySeries(title);

        for (Joueur u : ab) {
            series.add(u.getNom_joueur(), u.getAge_joueur());
    ...
    public void createPieChartForm(String titre, ArrayList<Joueur> ab) {
        // Generate the values
        ...
        f.getToolbar().addCommandToLeftBar("back", null, (ActionEvent evt)
                -> {
