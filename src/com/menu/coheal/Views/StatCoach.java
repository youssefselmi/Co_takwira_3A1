...
public class StatCoach {
   Resources theme ; 
     ...
     */
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Coach> ab) {
        CategorySeries series = new CategorySeries(title);

        for (Coach u : ab) {
            series.add(u.getNom_coach(), u.getSalaire());
    ...
    public void createPieChartForm(String titre, ArrayList<Coach> ab) {
        // Generate the values
        ...
        f.getToolbar().addCommandToLeftBar("back", null, (evt)
              ...
              new ListEntrainementForm(theme).showBack();
