 ...
 * @author esprit
 */
public class SupprimStadeController implements Initializable {
    ...
    @FXML
    private JFXButton BtnModiffier;
    @FXML
    ...
    @FXML
    private JFXTextField tf_nomS;
    @FXML
    private JFXComboBox<?> combo_id;
    @FXML
    private JFXButton refresh;
    @FXML
    private FontAwesomeIconView actualiser;
