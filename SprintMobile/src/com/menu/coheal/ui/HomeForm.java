...
import com.gestionMatch.gui.AddMatchForm;
...
public class HomeForm extends BaseForm {
    ...
    public HomeForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        Button matchsBtn = new Button();
        matchsBtn.addActionListener(e -> new ListeMatchForm(resourceObjectInstance).show());
        gui_eventsContainer.setLeadComponent(matchsBtn);
//        Button tasksBtn = new Button();
//        tasksBtn.addActionListener(e -> new TasksForm(resourceObjectInstance).show());
//        gui_tasksContainer.setLeadComponent(tasksBtn);
        Button stadeBtn = new Button();
         stadeBtn.addActionListener(e -> new ListeStadeForm(resourceObjectInstance).show());
 
        gui_booksContainer.setLeadComponent(stadeBtn);
